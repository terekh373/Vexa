...
const benefits = [
  {
    ...
    text: 'Повертайтеся до придбаних курсів',
  },
  {
    icon: Icon02,
    title: 'Персональні рекомендації',
    text: 'Продовжуйте навчання за планом',
  },
  {
    icon: Icon03,
    title: 'Навчання у власному темпі',
    text: 'Навчайтесь, коли зручно',
  },
  {
    icon: Icon04,
    title: 'Підтримка викладачів',
    text: 'Отримуйте своєчасні відповіді',
  },
  {
    icon: Icon05,
    title: 'Відстеження прогресу',
    text: 'Переглядайте свої результати',
  },
  {
    icon: Icon06,
    title: 'Сертифікати після навчання',
    text: 'Завантажуйте отримані сертифікати',
  },
];
...
const LoginPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (status === 429) {
        setFormError(
          'Забагато спроб входу. Зачекайте трохи та спробуйте ще раз.',
        );
      } else if (status === 401) {
        setFormError('Невірний email або пароль.');
      } else if (status === 403) {
        ...
        setFormError(
          'Не вдалося увійти. Перевірте з’єднання та спробуйте ще раз.',
        );
      }
    } finally {
      setSubmitting(false);
    ...
    <section className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.welcomeCard}>
          <div className={styles.welcomeHeader}>
            <h1 className={styles.welcomeTitle}>
              Ласкаво просимо назад до <span>Vexa</span>
            </h1>

            <p className={styles.welcomeSubtitle}>
              Продовжуйте навчання, відкривайте нові можливості
              <br />
              та розвивайте нові навички разом із нами
            </p>
          </div>
        ...
        <div className={styles.loginCard}>
          <h2 className={styles.loginTitle}>Вхід до акаунту</h2>

          {location.state?.registered && (
            <p className={styles.success}>
              Реєстрація успішна. Перейдіть за посиланням підтвердження
              з листа, а потім увійдіть.
            </p>
          )}

          {location.state?.passwordReset && (
            <p className={styles.success}>
              Пароль успішно змінено. Тепер ви можете увійти з новим
              паролем.
            </p>
          )}
